...
import { Upload, Library as LibraryIcon, Send } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-gray-400 transition-colors cursor-pointer">
          ...
          <h3 className="font-medium text-gray-900 mb-1">Drag or click to upload files</h3>
          <p className="text-sm text-gray-500">Choose files from your computer or a Vault project</p>
        </div>

        {/* Knowledge Source */}
        <div className="border border-gray-200 rounded-lg p-6">
          <div className="flex items-center gap-3 mb-3">
            <LibraryIcon className="h-6 w-6 text-gray-400" />
            <h3 className="font-medium text-gray-900">Choose knowledge source</h3>
          </div>
